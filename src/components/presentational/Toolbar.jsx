    ...
    <div className="toolbar-container">
      <div className="toolbar-header">
        <div className="styles">
          <span onClick={handleOpen} className={active.style ? 'active_tab':''}>Styles</span>

         
        </div>
        <div className="social">
          <span onClick={handleOpen} className={active.social ? 'active_tab':''}>Social</span>
        </div>
      </div>
      {showStyle.style && <h1>Style Toolbar loading</h1>}
